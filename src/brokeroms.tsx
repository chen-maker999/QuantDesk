  ...
  return <div className="page-body broker-oms">
    ...
    <div className="broker-grid">
      <section className="card broker-config"><h3><KeyRound size={15} />连接配置</h3>
        ...
        <div className="broker-inline"><label>最大挂单数<input type="number" min="1" max="200" value={currentDraft.max_open_orders} onChange={e => update("max_open_orders", Number(e.target.value))} /></label><span /></div>

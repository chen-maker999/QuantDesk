...
function launch(opts: LaunchOptions): void {
  ...
  streamAgent(
    { prompt: opts.prompt, threadId, model: opts.model, provider: opts.provider, reasoning: opts.reasoning, accessMode: opts.accessMode, role: opts.role, signal: controller.signal },
    event => {
